...
* Templates
** Introduction
Templates can refer to a number of different things at Tzeract: template keys, outcome templates, or outcome template sets. Template keys are a fundamental
building block of outcomes; they define a sort of atomic occurrence within a sporting event. A simulation matrix is built up of many columns where each column
represents a template key; e.g., /number of goals scored by the home team in the match/. 
...
| db.v2.internal.feed.mapping                |       1.2 |       153128 |
|--------------------------------------------+-----------+--------------|
| Totals                                     |     853.4 |      1402278 |
|--------------------------------------------+-----------+--------------|
#+TBLFM: @>$2=vsum(@<<$2..@>>$2)
#+TBLFM: @>$3=vsum(@<<$3..@>>$3)
